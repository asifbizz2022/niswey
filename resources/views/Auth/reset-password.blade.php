                        ...
                        <div class="auth-full-page-content p-md-5 p-4">
                            <div class="w-100">
                                ...
                                <div class="d-flex flex-column h-100">
                                  	<div style="padding-left: 3cm;" class="fs-3 text-uppercase fw-bold text-secondary">Reset Password</div>
                                    <div class=" "> 
            						
                                        <div class="" style="padding: 3cm;">	@include('notification')
                                            <form action="{{ route('reset.password') }}" method="post">@csrf 
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group auth-pass-inputgroup">
                                                        <input type="password" name="password" class="form-control" required autocomplete="new-password" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon">
